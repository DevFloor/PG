---
ESSAY_TITLE: Being Popular
URL: https://www.paulgraham.com/popular.html
DATE: May 2001
CONTENT:
_(This article was written as a kind of business plan for a [new language](https://www.paulgraham.com/arc.html). So it is missing (because it takes for granted) the most important feature of a good programming language: very powerful abstractions.)_
...
By way of summary, let's try describing the hacker's dream language. The dream language is [beautiful](https://www.paulgraham.com/taste.html), clean, and terse. It has an interactive toplevel that starts up fast. You can write programs to solve common problems with very little code. Nearly all the code in any program you write is code that's specific to your application. Everything else has been done for you.
