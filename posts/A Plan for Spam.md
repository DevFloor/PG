...
URL Source: https://www.paulgraham.com/spam.html

Markdown Content:
![Image 1: A Plan for Spam](https://s.turbifycdn.com/aah/paulgraham/a-plan-for-spam-5.gif)
...
[1] The examples in this article are translated into Common Lisp for, believe it or not, greater accessibility. The application described here is one that we wrote in order to test a new Lisp dialect called [Arc](https://www.paulgraham.com/arc.html) that is not yet released.
